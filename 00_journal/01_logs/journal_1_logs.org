...
<pre>
<code>> ./blog-1/00_journal/01_logs/journal_1_logs.md</code>
</pre>
...
@@html:<img src="https://drive.google.com/uc?export=view&id=1sYXB5n3Q86dGG4HLeMAzOT4zYaRwDTaT">@@
...
1. Create a table with two columns: @@html:<code>Task category</code>@@ and @@html:<code>Time spent</code>@@.
...
4. Add up the time taken per category, and record it under @@html:<code>Time spent</code>@@.
...
@@html:<img src="https://drive.google.com/uc?export=view&id=1e_DRuKaEHvn9x-Bh19zY7SY6y3EiVogB">@@

Here is a different set of data:

@@html:<img src="https://drive.google.com/uc?export=view&id=1fwYM6pu9wJcjyQZoF-iI1hcnaABSCaQD">@@
...
@@html:<img src="https://drive.google.com/uc?export=view&id=1-oQJSYm0f5pbOt4eflNpQ6GP1PE8-otj">@@
