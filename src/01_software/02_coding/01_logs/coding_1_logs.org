...
* E#004 (24/10/2022) - 03.2_variables (C)
:PROPERTIES:
:CUSTOM_ID: orge9efb7b
:END:
#+BEGIN_EXPORT html
...
<span class="comment-delimiter">/</span><span class="comment-delimiter">/ </span><span class="comment">** TEST 5: Create a program which will calculate the area of the circle that has a radius of 10. For Pi, use the value &quot;3.14&quot;. Print out your answer.</span><span class="comment">
</span></pre>
#+END_EXPORT

* E#003 (23/10/2022) - 03.1_variables (C)
:PROPERTIES:
...
* E#002 (02/10/2022) - 02_placeholders (C)
:PROPERTIES:
