...
# Current experience
As I have previously <a href="https://hnvy.github.io/blog-1/README.html">stated</a>, I am not an experienced programmer (though I hope to be one someday. Just think of all of the unlimited doors which you could open!). I used Notepad++ as my primary text editor while writing programs. I still use it (almost every day), but not for programming.
